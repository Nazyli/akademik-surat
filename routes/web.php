...
use App\Http\Controllers\User\Skpi\UserSkpiController;
...
Route::group(['namespace' => '', 'prefix' => 'admin',  'middleware' => ['auth', 'is_admin']], function () {
    ...
    Route::get('/get-data-by-department', [PengajuanAdminController::class, 'getByDepartmentId'])->name('getPengajuanByDepartmentId');
...
Route::group(['namespace' => '', 'prefix' => 'user',  'middleware' => ['auth', 'is_user']], function () {
    ...
    // SKPI
    Route::get('skpi/home', [UserSkpiController::class, 'userHome'])->name('user.skpi.home');
