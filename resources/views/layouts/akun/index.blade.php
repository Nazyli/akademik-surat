...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                <h5 class="card-header">{{ __('Account Setting') }}</h5>
                <!-- Account -->
                <div class="card-body">
                    <div class="d-flex align-items-start align-items-sm-center gap-4">
                        <img src="{{ $user->imgUrl() }}" alt="user-avatar" class="d-block rounded" height="100" width="100"
                            id="uploadedAvatar" />
                        <form id="updateImgForm" method="POST" action="{{ route('pengaturan-akun-updateImg', $user->id) }}"
                            ...
                            <div class="button-wrapper">
                                <label for="upload" class="btn btn-primary me-2 mb-4" tabindex="0">
                                    ...
                                    <input type="file" id="upload"
                                        ...
                                        name="upload_file" hidden accept="image/png, image/jpeg" onchange="submitForm()" />
                                </label>
                                @error('upload_file')
